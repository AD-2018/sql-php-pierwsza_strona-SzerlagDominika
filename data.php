...
echo("<br>Zad 9 <br>");
$sql = "select sum(YEAR(CURDATE())-YEAR(data_urodzenia)) as wiek, nazwa_dzial, imie from pracownicy, organizacja where id_org=dzial group by dzial order by wiek desc";
echo($sql);
